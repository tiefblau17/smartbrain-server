...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{D9413EE3-DA86-B489-1FF9-901A534E8F89}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    ...
    <Link>
      <AdditionalDependencies>kernel32.lib;user32.lib;gdi32.lib;winspool.lib;comdlg32.lib;advapi32.lib;shell32.lib;ole32.lib;oleaut32.lib;uuid.lib;odbc32.lib;DelayImp.lib;&quot;C:\Users\Dell\.node-gyp\10.13.0\x64\node.lib&quot;</AdditionalDependencies>
  ...
  <ItemGroup>
    <ClCompile Include="D:\Tools\Node.js\node_modules\npm\node_modules\node-gyp\src\win_delay_load_hook.cc"/>
  </ItemGroup>
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\bcrypt_lib.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;d:\Git\SmartBrain\smartbrain-api\node_modules\bcrypt\lib\binding&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)bcrypt_lib.node&quot; &quot;d:\Git\SmartBrain\smartbrain-api\node_modules\bcrypt\lib\binding\bcrypt_lib.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/bcrypt_lib.node to d:/Git/SmartBrain/smartbrain-api/node_modules/bcrypt/lib/binding\bcrypt_lib.node</Message>
      <Outputs>d:\Git\SmartBrain\smartbrain-api\node_modules\bcrypt\lib\binding\bcrypt_lib.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="bcrypt_lib.vcxproj">
      <Project>{E0C711C8-28FA-F7EF-FC7B-9519E2A57548}</Project>
